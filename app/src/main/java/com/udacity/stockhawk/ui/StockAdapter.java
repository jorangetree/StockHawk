...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    StockAdapter(Context context, StockAdapterOnClickHandler clickHandler) {
        ...
        dollarFormat = DataRepresentationFormat.dollarFormat();
        dollarFormatWithPlus = DataRepresentationFormat.dollarFormatWithPlus();
        percentageFormat = DataRepresentationFormat.percentageFormat();
    }
